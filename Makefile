...
CFLAGS += $(shell pkg-config --cflags wayland-client cairo pangocairo xkbcommon librsvg-2.0) \
	-std=c99 -Wall -Wextra -D_POSIX_C_SOURCE=200809L \
	-Wno-unused-parameter
LDLIBS = $(shell pkg-config --libs wayland-client cairo pangocairo xkbcommon librsvg-2.0) -lm
